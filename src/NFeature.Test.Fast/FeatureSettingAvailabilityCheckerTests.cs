...
namespace NFeature.Test.Fast
{
	...
	{
		private readonly FeatureSettingAvailabilityChecker<Feature, Tuple<FeatureVisibilityMode, Tenant, DateTime>, Tenant>
		...
		public void RecursivelyCheckAvailability_ADependsOnBAndAAndBStartDatesAreInPast_AIsAvailable()
		{
			...
			Assert.That(_dependencyChecker.RecursivelyCheckAvailability(featureSetting,
			                                                            allFeatureSettings,
			                                                            new Tuple<FeatureVisibilityMode, Tenant, DateTime>(
			                                                            	FeatureVisibilityMode.Normal, Tenant.All, DateTime.Now)));
		}
